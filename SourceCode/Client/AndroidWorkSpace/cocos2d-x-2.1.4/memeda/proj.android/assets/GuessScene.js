...
function MakeInputKeys(rightanswers, inputkeys) {
    ...
    var other = new Array('爱','情','公','寓', '包','青','天','流','星','花','园', '鹿','鼎','记', '神','探','狄','仁','杰', 
    					  ...
    					  '海','滩','如','此','的','夜','晚','大','进','军','险','地','姻','缘','订','三','死','亡','城','苦','海','孤',
    					  '雏','老','人','与','海','烽','火','异','乡','情','父','亲','离','家','时','无','情','大','地','补','情','天','以',
    					  '眼','还','眼','锦','绣','人','生','官','方','说','法');
...
GuessScene.prototype.CatEnter = function () {
    ...
    if ( this.catAni == null ) {
    	this.catAni = cc.BuilderReader.load("CatAni");
    	this.catLayout.addChild( this.catAni );
