...
{
    debugMsgOutput(gCatHand.animationManager.getLastCompletedSequenceName());
    ...
    if(gCatHand.animationManager.getLastCompletedSequenceName() == "Pull Timeline")
    {
        if(gCurrentGuessState == kGuessStatePullingChar)
        {
        ...
        if(gCurrentGuessState == kGuessStatePuttingResult)
        {
